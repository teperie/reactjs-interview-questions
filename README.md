...
| 13  | [setState()의 인수인 콜백 함수는 어떤 역할을 하나요?](#what-is-the-purpose-of-callback-function-as-an-argument-of-setstate)                                                                                   |
...
| 18  | [인라인 조건문(Inline Conditional Expressions)이란?](#what-are-inline-conditional-expressions)                                                                                                                                             |
| 19  | ["key" 속성은 무엇이고, 이걸 엘리먼트 배열에서 사용했을 때의 이점은 무엇인가요?](#what-is-key-prop-and-what-is-the-benefit-of-using-it-in-arrays-of-elements)                                                                     |
| 20  | [Ref의 용도는?](#what-is-the-use-of-refs)                                                                                                                                                                             |
| 21  | [Ref는 어떻게 만드나요?](#how-to-create-refs)                                                                                                                                                                                       |
| 22  | [Forward Ref란?](#what-are-forward-refs)                                                                                                                                                                                 |
| 23  | [콜백 Ref와 findDOMNode() 중 무엇을 우선해야하나요?](#which-is-preferred-option-with-in-callback-refs-and-finddomnode)                                                                                           |
| 24  | [문자열 Ref는 왜 레거시인가요?](#why-are-string-refs-legacy)                                                                                                                                                                       |
| 25  | [Virtual DOM은 무엇인가요?](#what-is-virtual-dom)                                                                                                                                                                                     |
| 26  | [Virtual DOM은 어떻게 동작하나요?](#how-virtual-dom-works)                                                                                                                                                                                 |
| 27  | [Shadow DOM과 Virtual DOM의 차이점은 무엇인가요?](#what-is-the-difference-between-shadow-dom-and-virtual-dom)                                                                                                         |
| 28  | [React Fiber는 무엇인가요?](#what-is-react-fiber)                                                                                                                                                                                     |
| 29  | [React Fiber의 주목적은 무엇인가요?](#what-is-the-main-goal-of-react-fiber)                                                                                                                                                   |
| 30  | [제어 컴포넌트(Controlled Component)란 무엇인가요?](#what-are-controlled-components)                                                                                                                                                               |
| 31  | [비제어 컴포넌트(Uncontrolled Component)란 무엇인가요?](#what-are-uncontrolled-components)                                                                                                                                                           |
| 32  | [createElement와 cloneElement의 차이점은?](#what-is-the-difference-between-createelement-and-cloneelement)                                                                                                 |
| 33  | [React에서 Lifting State Up은 무엇인가요?](#what-is-lifting-state-up-in-react)                                                                                                                                                         |
